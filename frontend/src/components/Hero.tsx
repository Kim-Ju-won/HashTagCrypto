      ...
      <div className="mx-auto max-w-5xl px-5">
        <div className="flex justify-between items-center gap-10 text-left flex-col lg:flex-row">
          ...
          <div className="flex-1 max-w-sm flex items-center justify-center">
            <svg viewBox="0 0 200 150" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
              <rect x="10" y="10" width="180" height="130" rx="10"
              ...
              <path d="M 30 70 Q 65 50, 100 60 T 160 20"
                    stroke="#F0C698" strokeWidth="4" fill="none"
        ...
        <div className="mt-8 text-center">
          <form className="flex justify-center max-w-xl mx-auto border border-gray-200 rounded-xl overflow-hidden shadow-sm bg-crypto-pureWhite">
            <input
              type="text"
            ...
            <button
              type="submit"
              className="px-6 py-3 font-semibold bg-crypto-lightLavender text-crypto-navy hover:bg-crypto-lavender transition-colors"
            >
              분석
            </button>
          </form>
